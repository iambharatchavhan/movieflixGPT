...
export const {addNowPlayingMovies,addMovieTrailer,addPopularMovies,addTopMovies,addUpComingMovies,addMovieVideo,addMovieDetails,addCastDetails} = nowPlayingMoviesSlice.actions;
